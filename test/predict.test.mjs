...
test('13. 일중 최고·최저값 판정 — 종가만 보면 놓치는 도달을 잡는다', () => {
  ...
  // 하루짜리 창은 그날 데이터 하나면 충분 — data-insufficient가 아니라 miss로 확정
  const oneDay = judgeMetric({ created: '2026-07-02T01:00:00Z', due: '2026-07-02', op: '>=', target: 1500 }, series, '2026-07-05');
  assert.equal(oneDay.state, 'miss');
  // 실시간 값 병합: 오늘 고가에 반영
